...
[![Go](https://github.com/bilpay-tech/air/actions/workflows/release.yml/badge.svg)](https://github.com/bilpay-tech/air/actions?query=workflow%3AGo+branch%3Amaster) [![Codacy Badge](https://app.codacy.com/project/badge/Grade/dcb95264cc504cad9c2a3d8b0795a7f8)](https://www.codacy.com/gh/bilpay-tech/air/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=bilpay-tech/air&amp;utm_campaign=Badge_Grade) [![Go Report Card](https://goreportcard.com/badge/github.com/bilpay-tech/air)](https://goreportcard.com/report/github.com/bilpay-tech/air) [![codecov](https://codecov.io/gh/bilpay-tech/air/branch/master/graph/badge.svg)](https://codecov.io/gh/bilpay-tech/air)
...
curl -sSfL https://raw.githubusercontent.com/bilpay-tech/air/master/install.sh | sh -s -- -b $(go env GOPATH)/bin

# or install it into ./bin/
curl -sSfL https://raw.githubusercontent.com/bilpay-tech/air/master/install.sh | sh -s
...
```bash
go install github.com/bilpay-tech/air@latest
```

### Docker

Please pull this docker image [bilpay-tech/air](https://hub.docker.com/r/bilpay-tech/air).
...
```bash
docker run -it --rm \
    -w "/go/src/github.com/bilpay-tech/hub" \
    -v $(pwd):/go/src/github.com/bilpay-tech/hub \
    -p 9090:9090 \
    bilpay-tech/air
```
</details>
...
RUN go install github.com/bilpay-tech/air@latest
...
Should use `\` to escape the `' in the bin. related issue: [#305](https://github.com/bilpay-tech/air/issues/305)
...
# Clone it
mkdir -p $GOPATH/src/github.com/bilpay-tech
cd $GOPATH/src/github.com/bilpay-tech
...
[![Star History Chart](https://api.star-history.com/svg?repos=bilpay-tech/air&type=Date)](https://star-history.com/#bilpay-tech/air&Date)

## Sponsor

<a href="https://www.buymeacoffee.com/bilpay-tech" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/default-orange.png" alt="Buy Me A Coffee" style="height: 51px !important;width: 217px !important;" ></a>
